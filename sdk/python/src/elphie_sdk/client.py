...
class ElphieClient(_GeneratedClient):
    ...
    def __init__(
        ...
        *,
        ...
        resolved_url = base_url or os.environ.get(
            "ELPHIE_API_URL", "http://localhost:8000"
        )
        self.base_url = resolved_url.rstrip("/")
        self.api_key = api_key or os.environ.get("ELPHIE_API_KEY")
    ...
    def __enter__(self) -> ElphieClient:
        return self
