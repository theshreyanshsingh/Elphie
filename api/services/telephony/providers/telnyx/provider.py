...
class TelnyxProvider(TelephonyProvider):
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # stream_bidirectional_codec controls only the Elphie → Telnyx direction.
        # The Telnyx → Elphie direction follows the PSTN leg and is announced via
    ...
    async def handle_websocket(
        ...
        try:
            ...
            # inbound direction (Telnyx → Elphie); the outbound direction is
