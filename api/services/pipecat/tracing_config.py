...
class _OrgAttributeSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if org_id:
            span.set_attribute("elphie.org_id", str(org_id))
...
class _OrgRoutingExporter(SpanExporter):
    ...
    Spans with a ``elphie.org_id`` attribute whose org has registered
    ...
    def export(self, spans):
        ...
        for span in spans:
            ...
            org_id = span.attributes.get("elphie.org_id") if span.attributes else None
...
def ensure_tracing() -> bool:
    ...
    setup_tracing(service_name="elphie-pipeline", exporter=_org_routing_exporter)
