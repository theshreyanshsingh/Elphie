...
def create_llm_service_from_provider(
    ...
    *,
    ...
    if provider == ServiceProviders.OPENAI.value:
        ...
        # The Elphie unified endpoint routes to an OpenAI-style reasoning model.
        # Without these controls the first turn spends ~30s "thinking" before the
        # first token. Mirror the gpt-5 branch to keep voice latency low.
