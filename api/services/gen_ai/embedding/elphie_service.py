"""Elphie-managed embedding service.

Routes embeddings through Elphie's managed proxy (MPS). This mirrors the managed
voice services (``ElphieLLMService`` / ``ElphieTTSService``): when a server-minted
...
class ElphieEmbeddingService(OpenAIEmbeddingService):
    """OpenAI-compatible embedding client pointed at Elphie's managed proxy."""
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Elphie-managed MPS service key.
