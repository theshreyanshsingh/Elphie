...
from api.services.configuration.registry import (
    ELPHIE_MULTILINGUAL_AUTODETECT_LANGUAGES,
...
class ModelConfigurationPricingResponse(BaseModel):
    ...
    elphie_model: ModelConfigurationMetricPrice | None = None
...
async def get_model_configuration_v2_defaults(
    ...
    return {
        "elphie": {
            ...
            "multilingual_languages": ELPHIE_MULTILINGUAL_AUTODETECT_LANGUAGES,
            "defaults": {
