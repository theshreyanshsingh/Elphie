"""Tests for the Elphie-managed embedding service and its correlation resolver."""
...
from api.services.gen_ai.embedding.elphie_service import ElphieEmbeddingService
...
def _service_with_fake_client(correlation_id):
    service = ElphieEmbeddingService(
        db_client=None,
        api_key="sk-test",
...
@pytest.mark.asyncio
async def test_elphie_embedding_forwards_v2_protocol_when_correlation_present():
...
@pytest.mark.asyncio
async def test_elphie_embedding_sends_plain_without_correlation():
