...
You build and edit Elphie voice-AI workflows **interactively** with the user using TypeScript that uses the `@elphie/sdk` package. Workflows are stored as JSON; this server projects them to TypeScript for editing and parses them back on save.
