...
<Tip>
**Using Claude Code or Codex?** Install the [Elphie setup skill](https://github.com/theshreyanshsingh/Elphie-plugins) (`/plugin marketplace add theshreyanshsingh/Elphie-plugins`, then `/plugin install elphie@elphie`) and ask your agent to *"set up Elphie for development"* — it runs the steps below for you and verifies the stack is healthy.
</Tip>
...
1. Fork [theshreyanshsingh/Elphie](https://github.com/theshreyanshsingh/Elphie) and clone **your fork**:

```bash
git clone https://github.com/<YOUR_HANDLE>/elphie
cd elphie
```
...
If these steps do not work for you, please open an issue on [GitHub](https://github.com/theshreyanshsingh/Elphie/issues).

<AccordionGroup>
<Accordion title="Cloned theshreyanshsingh/Elphie directly instead of your fork?">
Run `bash scripts/setup_fork.sh` once. It prompts for your fork URL, points `origin` at it, and adds `upstream` as `theshreyanshsingh/Elphie`. See [Fork and upstream remotes](/contribution/reference#fork-and-upstream-remotes).
</Accordion>
...
2. Push to your fork (`origin`) and open a pull request against `theshreyanshsingh/Elphie:main`.
3. A maintainer reviews and merges.

Bug reports and feature ideas go through [GitHub Issues](https://github.com/theshreyanshsingh/Elphie/issues) and [Ideas](https://github.com/orgs/theshreyanshsingh/discussions/categories/ideas). Issues tagged `good first issue` are a good place to start. For questions while you're working, use the [Elphie Community Slack](https://join.slack.com/t/elphie-community/shared_invite/zt-3zjb5vwvl-j7hRz3_F1SOn5cH~jm5f5g).
