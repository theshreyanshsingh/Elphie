...
description: Set up Elphie directly on your host without the devcontainer.
---
...
1. Run the contributor bootstrap. It configures `origin` as your fork and `upstream` as `elphie-hq/elphie`, initializes the pipecat submodule, creates the Python venv, and copies the `.env` templates.
<CodeGroup>
```bash macOS/Linux
