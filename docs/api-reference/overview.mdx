---
title: "Overview"
description: "Interact with Elphie programmatically via the REST API"
---
...
```
https://your-elphie-instance/api/v1
```

If you are using the hosted version, the base URL is `https://elphie.willowave.in/api/v1`.
...
```bash
curl -X POST https://your-elphie-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-elphie-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-elphie-instance",
