...
A **campaign** runs a workflow against a list of contacts. You upload a CSV of phone numbers, configure retry logic and scheduling, then start the campaign. Elphie dials contacts automatically up to your configured concurrency limit.
