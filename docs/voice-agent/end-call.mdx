...
End Call is the terminal node in a workflow. It fires right before Elphie terminates the connection, giving your agent one last chance to speak. Every path through your workflow must eventually reach an End Call node.
