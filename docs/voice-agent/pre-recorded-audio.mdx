...
## Step 2: Configure the cloned voice in Elphie

1. Go to your agent's **Model Configuration** in the Elphie dashboard.
...
Navigate to the **Recordings** page in the Elphie dashboard. Recordings are shared across all agents in your organization. You can either upload pre-recorded audio files or record directly in the browser.
