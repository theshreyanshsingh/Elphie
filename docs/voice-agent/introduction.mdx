...
description: "Elphie provides UI components to build a voice Agent. The voice agent can be created by going to https://elphie.nearzero.dev/workflow and then Creating a new Agent."
---
