...
description: "Assemble a Elphie voice agent programmatically with the SDK and save it as a draft"
---
...
- An existing agent ID to save drafts against (create one in the Elphie UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
