...
<iframe
  ...
  title="How to Build Your First Voice Agent in Elphie"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>

<Note>
Using the hosted platform, go to [elphie.willowave.in](https://elphie.willowave.in). Self-hosting locally? Use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>

## Step 1: Create an agent

Go to [elphie.willowave.in/workflow](https://elphie.willowave.in/workflow) and create a new agent.
