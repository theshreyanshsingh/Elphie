...
Then start a new session and ask it to *"set up Elphie"* (in Claude Code you can also run `/elphie-setup`). See [theshreyanshsingh/Elphie-plugins](https://github.com/theshreyanshsingh/Elphie-plugins) for details.
</Tip>
