...
- **GitHub Container Registry (Default)**: `ghcr.io/theshreyanshsingh` - Recommended for most users
...
REGISTRY=ghcr.io/theshreyanshsingh ./start_docker.sh

# Using Docker Hub
REGISTRY=elphieai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/theshreyanshsingh'; .\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'elphieai'; .\start_docker.ps1
```
</CodeGroup>
