...
- **GitHub Container Registry (Default)**: `ghcr.io/elphie-hq` - Recommended for most users
...
REGISTRY=ghcr.io/elphie-hq ./start_docker.sh
...
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/elphie-hq'
.\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'elphieai'
.\start_docker.ps1
```
</CodeGroup>
