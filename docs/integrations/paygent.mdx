...
description: "Connect Elphie to Paygent — real-time cost tracking, multimodal usage monitoring, and billing for voice agents"
---
...
Instead of building custom tracking infrastructure, you simply connect your Elphie workflow to Paygent. As your agents handle calls, Elphie passively calculates the exact multimodal token usage and audio duration. 
...
- A Elphie voice agent workflow

## Setup

### 1. Create an agent and configure pricing in Paygent

Before connecting Elphie, you must register your agent in Paygent and define how you want to charge your customers.
...
Next, set the **Indicator Name**. This is the billing event identifier you will pass from Elphie (e.g. `per-minute-call`) to tell Paygent which rate to apply for this agent's calls:
...
Once your pricing is configured, confirm your setup. You will use the **Agent ID** and **Indicator** from this process to connect your Elphie workflow.

### 2. Gather your Paygent credentials

You'll need three core values from your Paygent dashboard to link your Elphie agent:
...
In your Elphie workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Paygent**. The node will appear on your canvas with a **Not configured** badge.
