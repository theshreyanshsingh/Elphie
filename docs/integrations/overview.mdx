...
description: "Connect Elphie AI with external services and platforms"
---

## Introduction

Elphie AI provides a flexible integration architecture that allows you to connect with various external services and platforms. Our integration system is designed with modularity and extensibility in mind, making it easy to add new providers while maintaining backward compatibility.
...
- Visit our [GitHub Issues](https://github.com/theshreyanshsingh/Elphie/issues) for community support
- Join our [Slack community](https://join.slack.com/t/elphie-community/shared_invite/zt-3zjb5vwvl-j7hRz3_F1SOn5cH~jm5f5g) for assistance