...
2. Create a new application (or open the existing one whose name you configured in Elphie) with these settings:
   ...
   - **Application URL**: `https://api.elphie.com/api/v1/telephony/inbound/run`
   - **HTTP Method**: `POST`
...
3. Confirm:
   - **URL** is set to: `https://api.elphie.com/api/v1/telephony/inbound/run`
   - **Method** is `POST`
   ...
   <Note>
     ...
     self-hosted Elphie, replace `api.elphie.com` with your backend domain.
   </Note>
