...
description: "Connect Elphie to Tuner — the observability, simulation, and testing layer for voice"
---
...
Log in to [Tuner](https://app.usetuner.ai) and create a new agent. When configuring the agent, set the **Provider** to **Elphie**. Enter your **Agent Name** and choose the **Call Direction** (Inbound or Outbound) for your setup. The **Agent Remote ID** is auto-generated after you create the agent.

<img
  src="/images/tuner-create-agent.png"
  alt="Create a New Agent modal in Tuner — set Provider to Elphie"
/>
...
In your Elphie workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Tuner**.

<img
  src="/images/tuner-elphie-workflow-builder.png"
  alt="Elphie voice workflow builder — click Add node"
/>
...
<img
  ...
  alt="Elphie Integrations panel showing QA Analysis, Tuner, and Webhook"
/>
...
<img
  ...
  alt="Elphie Edit Tuner modal with credential fields and Enabled toggle"
/>
...
| Wrong agent in Tuner | Confirm the Tuner agent's Provider is set to **Elphie** |
