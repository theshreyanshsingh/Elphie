...
Elphie platform supports OpenAI, Google AI Studio, Google Vertex AI, Azure OpenAI, AWS Bedrock, Groq, OpenRouter, Hugging Face, MiniMax, Sarvam, and Elphie-managed LLMs. There are some models provided by default for you to choose from the drop down. 
...
For locally deployed or self-hosted LLMs, Elphie also supports OpenAI-compatible endpoints such as Ollama and vLLM.
