...
You can currently use OpenAI, Google, Groq, Azure and Elphie LLMs in LLM configuration. There are some models provided by default for you to choose from the drop down.
