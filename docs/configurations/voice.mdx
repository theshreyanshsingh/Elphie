...
Elphie platform supports ElevenLabs, OpenAI, Google, Azure Speech, Deepgram, Cartesia, Smallest AI, MiniMax, Sarvam, Rime, Inworld, Camb.ai, xAI, LMNT, and Elphie TTS engines. There are some voices from the providers that we ship by default. You can refer to the providers API documentation to select a voice ID that's most relevant for your language requirement.
...
For locally deployed or self-hosted TTS models, Elphie also supports Speaches, an OpenAI API-compatible server for speech generation.
