...
Elphie platform ships with Deepgram, Cartesia, OpenAI and Elphie transcribers by default. You can take a look at the providers documentation of which language to select for your language requirements.
