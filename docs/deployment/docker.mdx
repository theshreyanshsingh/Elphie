...
```
```text Codex
codex plugin marketplace add theshreyanshsingh/Elphie-plugins
codex plugin add elphie@elphie
```
</CodeGroup>

Start a new session, then ask it to *"set up Elphie"* (or run `/elphie-setup` in Claude Code). More at [theshreyanshsingh/Elphie-plugins](https://github.com/theshreyanshsingh/Elphie-plugins).
</Tip>
...
```
```powershell Windows
Invoke-WebRequest -OutFile docker-compose.yaml https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/docker-compose.yaml; Invoke-WebRequest -OutFile start_docker.ps1 https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/start_docker.ps1; .\start_docker.ps1
```
</CodeGroup>
...
<CodeGroup>
```bash macOS/Linux
curl -o setup_local.sh https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/setup_local.sh && chmod +x setup_local.sh && ./setup_local.sh
```
```powershell Windows
Invoke-WebRequest -OutFile setup_local.ps1 https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/setup_local.ps1; .\setup_local.ps1
```
</CodeGroup>
...
```bash
curl -o setup_remote.sh https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/setup_remote.sh && chmod +x setup_remote.sh && sudo ./setup_remote.sh
```
...
1. Clones the repo into `elphie/` (default: `theshreyanshsingh/Elphie@main`; the script will ask for an `owner/name` and `branch` so a fork can point at its own).
