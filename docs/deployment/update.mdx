...
- **GitHub Container Registry** — [github.com/orgs/theshreyanshsingh/packages](https://github.com/orgs/theshreyanshsingh/packages)
...
```bash
cd elphie
curl -o update_remote.sh https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/update_remote.sh
...
<CodeGroup>
```bash macOS/Linux
curl -o docker-compose.yaml https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/docker-compose.yaml
curl -o start_docker.sh https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/start_docker.sh && chmod +x start_docker.sh
docker compose down
./start_docker.sh
```
```powershell Windows
Invoke-WebRequest -OutFile docker-compose.yaml https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/docker-compose.yaml; Invoke-WebRequest -OutFile start_docker.ps1 https://raw.githubusercontent.com/theshreyanshsingh/Elphie/main/scripts/start_docker.ps1; docker compose down; .\start_docker.ps1
```
</CodeGroup>
...
<Warning>
Rolling back across a database migration is not always safe — if the newer release ran a schema migration, downgrading may leave the DB in a state the older API doesn't understand. If in doubt, [open an issue](https://github.com/theshreyanshsingh/Elphie/issues) before rolling back.
</Warning>
