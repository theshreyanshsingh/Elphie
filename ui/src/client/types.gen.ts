...
export type ClientOptions = {
    baseUrl: 'https://elphie.willowave.in' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., elphie_staging)
     */
...
export type ByokPipelineAiModelConfiguration = {
    ...
    embeddings?: ({
        ...
        provider: 'elphie';
    } & ElphieEmbeddingsConfiguration) | null;
};
 ...
 * Elphie
 */
export type ElphieEmbeddingsConfiguration = {
    /**
     * Provider
     */
    provider?: 'elphie';
     ...
     * Model
     *
     * Elphie-managed embedding model.
     */
    model?: string;
};
 ...
 */
export type ElphieManagedAiModelConfiguration = {
    /**
     * Api Key
     */
    api_key: string;
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. Elphie maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by Elphie from fixed values or workflow context templates.
     */
...
export type HttpTransferResolverConfig = {
     ...
     * Wait Message
     *
     * Optional short message played while Elphie resolves routing.
     */
...
export type ModelConfigurationPricingResponse = {
    ...
    elphie_model?: ModelConfigurationMetricPrice | null;
};
...
export type OrganizationAiModelConfigurationV2 = {
     ...
     */
    mode: 'elphie' | 'byok';
    elphie?: ElphieManagedAiModelConfiguration | null;
...
export type GetVoicesApiV1UserConfigurationsVoicesProviderGetData = {
    ...
    path: {
         ...
         * Provider
         */
        provider: 'elevenlabs' | 'deepgram' | 'sarvam' | 'cartesia' | 'elphie' | 'rime';
    };
    query?: {
        /**
         * Model
...
export type ActiveCallsApiV1HealthActiveCallsGetData = {
    ...
    headers?: {
        /**
         * X-Elphie-Devops-Secret
         */
        'X-Elphie-Devops-Secret'?: string | null;
    };
    path?: never;
    query?: never;
