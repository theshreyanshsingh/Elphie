...
import { APP_NAME, DOCS_BASE } from "@/constants/branding";
    ...
    <AppPageContent width="2xl" className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Let AI agents access your {APP_NAME} workspace and documentation via
              the Model Context Protocol.{" "}
              <a
                href={`${DOCS_BASE}/integrations/mcp`}
                target="_blank"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              <a
                href={`${DOCS_BASE}/configurations/tracing`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-0.5 underline"
              >
