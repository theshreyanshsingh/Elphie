        ...
        <AppPageContent width="6xl">
                    ...
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>{APP_NAME} Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage service keys for accessing {APP_NAME} AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text-xs text-muted-foreground">
                                            Configure service keys in Model Configurations to access {APP_NAME} AI services.
                                        </span>
                                    )}
                                </div>
                            </div>
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access {APP_NAME} AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                                <p className="text-sm text-blue-600 dark:text-blue-500">
                                    This key provides access to {APP_NAME} AI services including LLM, Text-to-Speech, and Speech-to-Text.
