...
- Elphie-specific realtime provider adapters live under `api/services/pipecat/realtime/`
...
- in Elphie, common examples include telephony, workflow execution, generated SDK surfaces, and other service subtrees that span many files
